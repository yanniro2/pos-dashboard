...
const ShowSummary = (props: Props) => {
  return (
    <div className="flex items-start capitalize flex-col justify-between w-full h-full overflow-x-auto gap-1 bg-primary p-1 pb-[3rem] rounded-lg">
      <div className="flex flex-col gap-1 items-start w-full h-min">
        <div className="w-full justify-between items-center bg-white p-1 rounded-lg flex">
          <h1 className="text-primary">total Quantity</h1>
        ...
        <div className="w-full justify-between items-center bg-white p-1 rounded-lg flex">
          <h1 className="text-primary">sub total</h1>
      ...
      <div className="w-full justify-between items-center bg-white p-1 rounded-lg flex uppercase h-min">
        <h1 className="text-primary font-bold ">Grand total</h1>
        <h1 className="font-bold text-primary">{props.grandTotal}$</h1>
      </div>
    </div>
  );
};
